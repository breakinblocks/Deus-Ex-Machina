...
public class KnockbackBuff extends AbstractBuff {
    ...
    public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(DeusExMachina.MODID, "knockback");
    ...
    public Component getDisplayName() {
        return Component.translatable("buff.deus_ex_machina.knockback");
    }

    @Override
    public int getColor() {
        return 0xFF7777FF; // Light blue
    }

    @Override
    public BuffSettings getDefaultSettings() {
        return new BuffSettings(0, 200, 10, ResetEnum.FULL);
    }
