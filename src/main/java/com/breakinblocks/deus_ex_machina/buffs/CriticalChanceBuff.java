...
public class CriticalChanceBuff extends AbstractBuff {
    ...
    public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(DeusExMachina.MODID, "critical_chance");
    ...
    public Component getDisplayName() {
        return Component.translatable("buff.deus_ex_machina.critical_chance");
    }
    ...
    public BuffSettings getDefaultSettings() {
        return new BuffSettings(0, 75, 5, ResetEnum.FULL);
    }

    @Override
    public float apply(int value, float damage, BuffContext context) {
        // value=25 -> 25% chance for 1.5x damage
