...
public class ThornsBuff extends AbstractBuff {
    ...
    public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(DeusExMachina.MODID, "thorns");
    ...
    public Component getDisplayName() {
        return Component.translatable("buff.deus_ex_machina.thorns");
    }

    @Override
    public int getColor() {
        return 0xFF8B4513; // Brown/thorny
    }

    @Override
    public BuffSettings getDefaultSettings() {
        return new BuffSettings(0, 100, 5, ResetEnum.FULL);
    }

    @Override
    public float apply(int value, float damage, BuffContext context) {
        // Reflect value% of damage back to attacker
        ...
        return damage; // Still take full damage
    }
}
