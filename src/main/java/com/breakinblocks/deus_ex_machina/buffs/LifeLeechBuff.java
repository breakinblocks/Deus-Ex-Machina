...
public class LifeLeechBuff extends AbstractBuff {
    ...
    public static final ResourceLocation ID = new ResourceLocation(DeusExMachina.MODID, "life_leech");

    @Override
    public ResourceLocation getId() { return ID; }

    @Override
    public BuffCategory getCategory() { return BuffCategory.HEALTH; }

    @Override
    public Component getDisplayName() { return Component.translatable("buff.deus_ex_machina.life_leech"); }

    @Override
    public int getColor() { return 0xFFFF55FF; }

    @Override
    public BuffSettings getDefaultSettings() { return new BuffSettings(0, 25, 2, ResetEnum.FULL); }
    ...
    @Override
    public boolean appliesOnPlayerHurt() { return false; }
