...
public class KnockbackResistanceBuff extends AbstractBuff {
    ...
    public static final ResourceLocation ID = new ResourceLocation(DeusExMachina.MODID, "knockback_resistance");
    ...
    @Override
    public Component getDisplayName() { return Component.translatable("buff.deus_ex_machina.knockback_resistance"); }

    @Override
    public int getColor() { return 0xFF4444AA; }

    @Override
    public BuffSettings getDefaultSettings() { return new BuffSettings(0, 100, 10, ResetEnum.FULL); }
