...
public class ExecuteBuff extends AbstractBuff {
    ...
    public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(DeusExMachina.MODID, "execute");
    private static final float HEALTH_THRESHOLD = 0.3f; // Below 30% health
    ...
    public Component getDisplayName() {
        return Component.translatable("buff.deus_ex_machina.execute");
    }
