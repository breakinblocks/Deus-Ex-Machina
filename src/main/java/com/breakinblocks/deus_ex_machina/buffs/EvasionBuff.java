...
public class EvasionBuff extends AbstractBuff {
    ...
    public static final ResourceLocation ID = new ResourceLocation(DeusExMachina.MODID, "evasion");
    ...
    @Override
    public Component getDisplayName() { return Component.translatable("buff.deus_ex_machina.evasion"); }

    @Override
    public int getColor() { return 0xFF55FFFF; }
