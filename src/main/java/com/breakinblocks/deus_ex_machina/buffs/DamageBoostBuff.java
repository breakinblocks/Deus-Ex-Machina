...
public class DamageBoostBuff extends AbstractBuff {
    ...
    public static final ResourceLocation ID = new ResourceLocation(DeusExMachina.MODID, "attack_boost");
    ...
    @Override
    public Component getDisplayName() { return Component.translatable("buff.deus_ex_machina.attack_boost"); }

    @Override
    public int getColor() { return 0xFFFF5555; }

    @Override
    public BuffSettings getDefaultSettings() { return new BuffSettings(0, 50, 3, ResetEnum.FULL); }
