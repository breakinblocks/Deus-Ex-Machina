...
public class ResistanceBuff extends AbstractBuff {
    ...
    public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(DeusExMachina.MODID, "resistance");
    ...
    public Component getDisplayName() {
        return Component.translatable("buff.deus_ex_machina.resistance");
    }
    ...
    public BuffSettings getDefaultSettings() {
        return new BuffSettings(0, 80, 5, ResetEnum.FULL);
    }
